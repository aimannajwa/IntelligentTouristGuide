...
<body>
 ...
 <section id="plan" class="section">
    ...
    <a href="plan3.php"><button type="button" class="btn btn-danger" name="cancel">Cancel</button></a>
         <a href="selectCategory3.php"><button type="button" id="requestthis" class="btn btn-success">Next</button></a>
     </form>    
    ...
    $(function() { //ready function
        $('#requestthis').on('click', function(e){ //click event
            ...
            var area = $('#area').val();
             ...
             var url = "selectCategory3.php?placeId="+placeId+"&placeId2="+placeId2+"&area="+area;
