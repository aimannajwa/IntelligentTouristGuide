...
<div class="btnn">
<center>
<a href="plan2.php"><button type="button" class="btn btn-danger" name="cancel">Cancel</button></a>
<a href="selectPlace2.php"><button type="button" id="requestthis" class="btn btn-success">Next</button></a>
...
<script type="text/javascript">
    $(function() { //ready function
        $('#requestthis').on('click', function(e){ //click event
			...
			var area = $('#area').val();
			 var tag = $('#tag').val();
            var url = "selectPlace2.php?placeId="+placeId+"&area="+area+"&tag="+tag;
