			...
			if(isset($_POST['submit']))
{
	...
	$queryIns = "INSERT INTO plan (id, placeId1, placeId2, placeId3) VALUES ('$id', '$placeId', '$placeId2', 0)";
	$result = mysqli_query($con,$queryIns);
	
		
		echo"<script type='text/javascript'>
	 	 alert('Enjoy the trip!')
		 location.href='map2.php'
		 </script>";
}
...
<br>
                ...
                <form role="form" name="place" action="selectPlace2.php" method="POST" enctype="multipart/form-data" >                         
              ...
              <?php
			   ...
			   ?>
              	<tr>
				    ...
				    <td>
				    <input type="checkbox" class="place" name="placeId2" value="'.$row['placeId'].'" onClick="keepCount()" id="placeId2">
				    </td>
       ...
       <input type="hidden" name="placeId" value="<?php echo $placeId ?>" id="placeId">
                 ...
                 <br> 
                  ...
                  <div class="btnn">
                  <center>
    <button type="submit" class="btn btn-danger" name="submit">Go to the map!</button>
        <a href="plan3.php"><button type="submit"  id="requestthis" class="btn btn-success">Next Destination!</button></a>
...
<script type="text/javascript">
    $(function() { //ready function
        $('#requestthis').on('click', function(e){ //click event
            ...
            var url = "plan3.php?placeId="+placeId+"&placeId2="+placeId2;
