			...
			if(isset($_POST['submit']))
{
	...
	$placeId2=$_POST['placeId2'];
	$placeId3=$_POST['placeId3'];
	
	
	$queryIns = "INSERT INTO plan (id, placeId1, placeId2, placeId3) VALUES ('$id', '$placeId', '$placeId2', '$placeId3')";
...
<br>
                ...
                <form role="form" name="place" action="selectPlace3.php" method="POST" enctype="multipart/form-data" >                         
              ...
              <?php
			   ...
			   ?>
              	<tr>
				    ...
				    <td>
				    <input type="checkbox" class="place" name="placeId3" value="'.$row['placeId'].'" onClick="keepCount()" id="placeId3">
				    </td>
       ...
       <input type="hidden" name="placeId2" value="<?php echo $placeId2 ?>">
                 ...
                 <br> 
                  ...
                  <div class="btnn">
                  <center>
    <a href="plan3.php"><button type="submit" class="btn btn-danger" >Cancel</button>
       <a href="map.php"><button type="submit" name="submit" class="btn btn-success">Go To The Destination!</button></a>
