...
<body>
 ...
 <section id="plan" class="section">
            ...
            <p>
              This is where you can create your plan! Let's begin!
                ...
                <label for="tag" class="loginFormElement">Area: </label>
                    <select class="form-control" id="area" name="Area"  oninput="myFunction()" required><option value="">Please Select Area</option>
    ...
    <a href="plan.php"><button type="button" class="btn btn-danger" name="cancel">Cancel</button></a>
         <a href="selectCategory.php"><button type="button" id="requestthis" class="btn btn-success">Next</button></a>
