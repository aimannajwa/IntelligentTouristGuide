                ...
                <!-- Sidebar navigation-->
                  <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="addLocation.php" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Place</span><span class="fa fa-angle-right" style="float: right"></span></a>
                        <ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View Feedback</h3>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="feedbackTable" class=" table-striped table-bordered " cellspacing="1" width="100%">
              <thead>
                <tr>
                  <th >ID</th>
                  <th >Feedback</th>
...
for ($i=1; $i<=$total_pages; $i++) {
	...
	if($page == $i)
	{ 
	 $pagLink .= "<a href='feedback.php?page=".$i."' class='active'>".$i."</a>";
	}  
	else
	{
	 $pagLink .= "<a href='feedback.php?page=".$i."'>".$i."</a>";
	}
