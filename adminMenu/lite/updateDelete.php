<?php
		...
		if($_SESSION['email'] == "")
		{
			...
			$query = mysqli_query($con, "SELECT * FROM place");
...
$sql = "SELECT * FROM place ORDER BY placeId ASC LIMIT $start_from, $limit";  
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Update/Delete Location</h3>
                    </div>
...
<br>
         <!-- ============================================================== -->
              ...
              <table id="locationTable" class=" table-striped table-bordered " cellspacing="1" width="100%">
              <thead>
                <tr>
                  <th >Place ID</th>
                  <th >Location Name</th>
              ...
              <?php
			   ...
			   ?>
              	<tr>
                    ...
                    <?php echo'
                    <td><img src="img/'.$row['image'].'" width="250" height="180" /></td> 
				    <td>
				     <a href="updateLocation.php?placeId='.$id.'" class="btn btn-success">UPDATE</a>
				     <br>
				     <br>
				    <a href="deleteLocation.php?placeId='.$id.'" class="btn btn-danger">DELETE</a>
				    </td>
...
$sql = "SELECT COUNT(placeId) FROM place";  
$rs_result = mysqli_query($con,$sql); 
...
for ($i=1; $i<=$total_pages; $i++) {
	...
	if($page == $i)
	{ 
	 $pagLink .= "<a href='updateDelete.php?page=".$i."' class='active'>".$i."</a>";
	}  
	else
	{
	 $pagLink .= "<a href='updateDelete.php?page=".$i."'>".$i."</a>";
	}
